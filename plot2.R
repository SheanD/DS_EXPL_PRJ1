## CREATES COUSERA JOHN HOPKINS EXPLORATORY DATA ANALYSIS PROJECT 1 PLOT 2
...
png(filename="C:/WORKINGDIRECTORY/plot2.png")
  par(mfrow=c(1,1))
  plot2 <- select(prjdata, DateTime, Global_active_power)
  plot(plot2, type="l",xlab="",ylab="Global Active Power (kilowatts)")
dev.off()
